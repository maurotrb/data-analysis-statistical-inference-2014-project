...
```{r summary_graphs, warning=FALSE, fig.width=12, fig.height=5}
par(mfrow = c(1, 3), mar=c(8,4,2,2), oma=c(3,0,1,0))
...
mtext("Figure 1. Exploratory analysis. Summary graphs.", side=1, line=1, outer=TRUE)
```

**Highest Degree** is a categorical variable. We summarize it with a frequency table
and a barplot (see Figure 1).
