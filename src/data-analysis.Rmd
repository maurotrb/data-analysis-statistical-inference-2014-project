...
So we first use a method called **analysis of variance** (ANOVA) [[3](#openintro)]
...
with more sophisticated statistical method could be made to obviate to the problem
in the data.

Outliers in groups. Probably other variables could explain income.

Moreover it could be interesting doing the study for various year in the GSS survey
...
2. <a name="gssfaq"/>General Social Survey (GSS) FAQ.
   ...
   Accessed 03/30/2014
3. <a name="openintro"/>Comparing many means with ANOVA. In Diez M David, Barr D
