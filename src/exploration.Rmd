...
summary(gss$coninc)
par(mar = c(5, 4, 4, 2) + 0.1)
hist(gss$coninc, main="Total family income in constant dollars")
```

Total family income in constant dollars by Degree.
```{r degree_coninc, warning=FALSE}
par(mar = c(8, 4, 4, 2) + 0.1)
boxplot(gss$coninc ~ gss$degree, las= 2, main="Total family income in constant dollars by Degree")
```
